...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { category: @tutorial.category, contenido: @tutorial.contenido, slug: @tutorial.slug, title: @tutorial.title, video: @tutorial.video } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { category: @tutorial.category, contenido: @tutorial.contenido, slug: @tutorial.slug, title: @tutorial.title, video: @tutorial.video } }
